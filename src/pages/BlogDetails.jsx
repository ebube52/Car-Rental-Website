              ...
              <div className="comment__list mt-5">
                ...
                <div className="single__comment d-flex gap-3">
                  ...
                  <div className="comment__content">
                    <h6 className=" fw-bold">David Gordon</h6>
                    <p className="section__description mb-0">14 July, 2022</p>
                    <p className="section__description">
                      "I rented a luxury SUV for a business trip, and it exceeded my expectations.
                       The vehicle was in perfect condition, and the service was top-notch.
                       I appreciated the flexibility in pick-up and drop-off times. Highly recommend!"
                    </p>
